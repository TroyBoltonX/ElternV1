...
public class RemindersElderlyActivity extends Activity {
    ...
    private AppointmentAdapterElder adapter2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_reminders_elderly);
            ...
            query.findInBackground(new FindCallback<ParseObject>() {
                ...
                public void done(List<ParseObject> appointmentlist, ParseException e) {
                    ...
                    if (appointmentlist.size() > 0) {
                        ...
                        adapter = new AppointmentAdapterElder(RemindersElderlyActivity.this, appointments);
...
// Create dialog and display it to the user
        ...
        appointmentList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                Intent intent = new Intent(view.getContext(), EditReminderElderActivity.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch(item.getItemId())
        {
            ...
            case R.id.add:
                Intent intent = new Intent(RemindersElderlyActivity.this, AddRemindersElderlyActivity.class);
                startActivityForResult(intent, ADD_REMINDER_REQUEST);
                break;

            //go to past remuinders screen for carer
            case R.id.past:
                Intent intent2 = new Intent(RemindersElderlyActivity.this, PastRemindersElderlyActivity.class);
            ...
            query.findInBackground(new FindCallback<ParseObject>() {
                ...
                public void done(List<ParseObject> appointmentlist, ParseException e) {
                    ...
                    if (appointmentlist.size() > 0) {
                        ...
                        adapter2 = new AppointmentAdapterElder(RemindersElderlyActivity.this, appointments);
