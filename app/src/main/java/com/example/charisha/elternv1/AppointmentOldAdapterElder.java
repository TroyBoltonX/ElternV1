 ...
 */
public class AppointmentOldAdapterElder extends BaseAdapter {
    private Context context;
    private ArrayList<Appointment> appointments;

    public AppointmentOldAdapterElder(Context context, ArrayList<Appointment> appointments) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            ...
            view = inflater.inflate(R.layout.list_appointment_old_item_elder, null);
            ...
            if (!appointments.get(i).getCompleted()) {
                ...
                //        completedImage.setImageResource(R.drawable.donee);
