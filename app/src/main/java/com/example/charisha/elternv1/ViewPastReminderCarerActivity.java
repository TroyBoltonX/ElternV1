...
public class ViewPastReminderCarerActivity extends Activity implements AdapterView.OnItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_past_reminder_carer);
        Intent i = getIntent();
...
*/
      ...
      //  String dateTime = "Date: "+ currentAppointment.getDate()+"\nTime: "+currentAppointment.getTime();
        ...
        if (isNetworkConnected()) {
            ...
            if (checkDate() == true) {
                ...
                if (!currentAppointment.getCompleted() == completedBox.isChecked()) {
                    AlertDialog.Builder builder2 = new AlertDialog.Builder(ViewPastReminderCarerActivity.this);
                    ...
                    builder2.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialogInterface, int i) {
                            ...
                            if (titleEditText.getText().toString().equals("") || titleEditText.getText().toString().isEmpty()
                                ...
                                // Use the AlertDialog Builder utility to create the dialog
                                AlertDialog.Builder builder = new AlertDialog.Builder(ViewPastReminderCarerActivity.this);
// Set message and title for dialog (we can chain methods here!)
...
// Create dialog and display it to the user
                                ...
                                query.getFirstInBackground(new GetCallback<ParseObject>() {
                                    public void done(ParseObject object, ParseException e) {
                                        if (object == null) {
                                            ...
                                            Intent intent2 = new Intent(ViewPastReminderCarerActivity.this, SmsCarerActivity.class);
                    ...
                    builder2.setNegativeButton("No", new
                            DialogInterface.OnClickListener() {
                                @Override
                                public void onClick(DialogInterface dialogInterface, int i) {
                                    Intent intent = new Intent(ViewPastReminderCarerActivity.this, SmsCarerActivity.class);
