...
public class FIndToiletActivity extends Activity implements LocationListener {

    private Double lat = 0.0;
    private Double longi = 0.0;

    private AnnotationView annotation;
    private OverlayItem[] point = new OverlayItem[4000];
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ParseQuery<ParseObject> query = ParseQuery.getQuery("VicToilet");
        query.setLimit(4000);
                    ...
                    for(int i = 0; i < hospitallist.size(); i++){
                        ...
                        point[i] = new OverlayItem(
                                new GeoPoint (Double.parseDouble(hospitallist.get(i).getString("Latitude")),
                                        Double.parseDouble(hospitallist.get(i).getString("Longitude"))), hospitallist.get(i).getString("Address1"), hospitallist.get(i).getString("Town"));
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_find_toilet, menu);
        return true;
    }
