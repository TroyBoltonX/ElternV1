 ...
 * Class to view and edit a reminder
 */

public class EditReminderCarerActivity extends Activity implements AdapterView.OnItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_edit_reminder_carer);
        Intent i = getIntent();
        ...
        TextView elderTV = (TextView) findViewById(R.id.elderTV);
        ...
        elderTV.setText(currentAppointment.getToWho());
...
*/
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_edit_reminder_carer, menu);
        return true;
    }
    ...
    public void editReminder(View v) {
        ...
        if (isNetworkConnected()) {
            ...
            if (checkDate() == true) {
                ...
                if (!currentAppointment.getTitle().equals(titleEditText.getText().toString().trim()) ||
                        !currentAppointment.getDescription().equals(descriptionEditText.getText().toString().trim())
                        || !currentAppointment.getTime().equals(time) || !currentAppointment.getDate().equals(date)
                        || !currentAppointment.getFrequency().equals(frequency)
                        || !currentAppointment.getCompleted() == completedBox.isChecked()) {
                    AlertDialog.Builder builder2 = new AlertDialog.Builder(EditReminderCarerActivity.this);
                    ...
                    builder2.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialogInterface, int i) {
                            ...
                            if (titleEditText.getText().toString().equals("") || titleEditText.getText().toString().isEmpty()
                                ...
                                AlertDialog.Builder builder = new AlertDialog.Builder(EditReminderCarerActivity.this);
...
//                        .append(year).append(" "));
  ...
  */
    public void smsReminder(View view){
        ...
        if (isNetworkConnected()) {
            ...
            if (checkDate() == true) {
                ...
                if (!currentAppointment.getTitle().equals(titleEditText.getText().toString().trim()) ||
                        ...
                        || !currentAppointment.getCompleted() == completedBox.isChecked())
                {
                    System.out.println("current  " + currentAppointment.getTitle() +"  " + titleEditText.getText().toString());
                    System.out.println("current  " + currentAppointment.getDescription() +"  " + descriptionEditText.getText().toString());
                    System.out.println("current  " + currentAppointment.getTime() +"  " +  time);
                    System.out.println("current  " + currentAppointment.getDate() +"  " +  date);
                    System.out.println("current  " + currentAppointment.getFrequency() +"  " +  frequency);
                    System.out.println("current  " + currentAppointment.getCompleted() +"  " +  completedBox.isChecked());
...
// Create dialog and display it to the user
                                ...
                                query.getFirstInBackground(new GetCallback<ParseObject>() {
                                    public void done(ParseObject object, ParseException e) {
                                        if (object == null) {
                                            ...
                                            Intent intent2 = new Intent(EditReminderCarerActivity.this, SmsCarerActivity.class);
                                            intent2.putExtra("Appointment", currentAppointment);
                                            startActivityForResult(intent2, SMS_REMINDER_REQUEST);
                                        }
                                    }
                                });
                            }
                    ...
                    builder2.setNegativeButton("No", new
                            DialogInterface.OnClickListener() {
                                @Override
                                public void onClick(DialogInterface dialogInterface, int i) {
                                    Intent intent = new Intent(EditReminderCarerActivity.this, SmsCarerActivity.class);
                    ...
                    Appointment newAppointment = currentAppointment;
                    Intent intent = new Intent(EditReminderCarerActivity.this, SmsCarerActivity.class);
