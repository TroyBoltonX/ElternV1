...
public class EditReminderElderActivity extends Activity implements AdapterView.OnItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_edit_reminder_elder);
        Intent i = getIntent();
        ...
        if (isNetworkConnected()) {
            ...
            if (checkDate() == true) {
                ...
                if (!currentAppointment.getTitle().equals(titleEditText.getText().toString().trim()) ||
                    ...
                    AlertDialog.Builder builder2 = new AlertDialog.Builder(EditReminderElderActivity.this);
                    ...
                    builder2.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialogInterface, int i) {
                            ...
                            if (titleEditText.getText().toString().equals("") || titleEditText.getText().toString().isEmpty()
                                ...
                                AlertDialog.Builder builder = new AlertDialog.Builder(EditReminderElderActivity.this);
...
// Create dialog and display it to the user
                                ...
                                query.getFirstInBackground(new GetCallback<ParseObject>() {
                                    public void done(ParseObject object, ParseException e) {
                                        if (object == null) {
                                            ...
                                            Intent intent2 = new Intent(EditReminderElderActivity.this, SmsElderlyActivity.class);
                    ...
                    builder2.setNegativeButton("No", new
                            DialogInterface.OnClickListener() {
                                @Override
                                public void onClick(DialogInterface dialogInterface, int i) {
                                    Intent intent = new Intent(EditReminderElderActivity.this, SmsElderlyActivity.class);
